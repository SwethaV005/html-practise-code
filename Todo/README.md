...
A simple To-Do List application built using React. The application allows users to enter a task, add it to the list, and delete tasks. The project is divided into reusable React components such as the input container and individual todo items. :contentReference[oaicite:0]{index=0}
...
This project helped me understand the basics of React state management, props, component communication, controlled inputs, event handling, and updating arrays in state.
